...
parser.add_argument("--onnx-config", required=True)
...
ort_encoder = TextEncoderInference.create_from_config(args.onnx_config, device=args.device)
base_model = ort_encoder.base_model
...
print(base_model, 'onnx', args.batch_size, 'cpu', p1, p2, sep='\t')
